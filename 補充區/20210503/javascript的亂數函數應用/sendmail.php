 <?php
          ...
          //$mail->From = "milkbear2019@gmail.com"; //寄件者信箱 $_POST['mailfrom']
          ...
          $mail->AddAddress($_POST['mailto']); //收件人郵件
          ...
          <tr>
            ...
            <div id="contentDiv">
              <table width="100%" border="0" cellpadding="5" cellspacing="0">
                ...
                <tr>
                  <td colspan="2" align="center"><input type="button" name="button2" id="button2" value="再寄一封" onclick="history.go(-1);"></td>
                </tr>
              </table>
            </div></td>
          </tr>
